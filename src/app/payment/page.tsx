            ...
            <Tabs defaultValue="tarjeta" className="w-4/5 mx-auto pb-5">
                ...
                >
                    <div className="flex flex-col gap-4 items-center justify-center text-center">
                        <h2 className="text-lg font-semibold">Pago por QR</h2>
                        <p className="text-sm text-muted-foreground max-w-sm">
                            Genera un código QR para pagar con tarjeta de
                            crédito o débito desde tu aplicación bancaria.
                        </p>

                        {!qrGenerado ? (
                            <Button
                                variant="secondary"
                                onClick={() => setQrGenerado(true)}
                                className="mt-2"
                            >
                                Generar QR
                            </Button>
