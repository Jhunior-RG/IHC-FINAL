    ...
    return (
        <div className="flex flex-col py-10 min-h-screen">
            <div className="container mx-auto px-4 max-w-6xl">
                <h1 className="text-3xl font-bold text-center pb-10 text-gray-900">
                    ...
                    <DialogContent className="sm:max-w-md">
                        ...
                        <div className="flex flex-col items-center justify-center py-8 px-6">
                            ...
                            <div className="text-center space-y-3">
                                <h2 className="text-2xl font-bold text-green-700 animate-fade-in">
                                    ¡Pago Confirmado!
                                </h2>
                                ...
                                <p className="text-sm text-gray-500 animate-fade-in animation-delay-700">
                                    Redirigiendo a tus pedidos en unos
                                    segundos...
                                </p>
                            </div>
                    ...
                    <CardContent>
                        <Tabs defaultValue="delivery" className="w-full">
                            <TabsList className="grid w-full grid-cols-2 mb-6">
                                ...
                                >
                                    <Smartphone className="h-4 w-4" />A
                                    domicilio
                                </TabsTrigger>
                                <TabsTrigger
                                    value="pickup"
                                ...
                                <div className="max-w-md mx-auto space-y-6">
                                    <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-6">
                                        ...
                                        <p className="text-gray-600 text-sm mb-4">
                                            ...
                                            aplicación bancaria para completar
                                            el pago
                                        </p>
