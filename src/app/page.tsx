...
const Page = () => {
    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
            // This was causing the warning, but since we removed currentTestimonial, we can remove this interval
        }, 4000);
            ...
            <div className="bg-primary relative overflow-hidden">
                ...
                <div className="h-screen flex sm:flex-row flex-col-reverse justify-center items-center relative z-10">
                    ...
                    <div className="relative h-full w-full flex items-end justify-start">
                        ...
                        />
                        <Image
                            className={`absolute left-0 bottom-0 transition-all duration-1000 delay-300 ${
                                isVisible
                    ...
                    <div className="flex flex-col items-center justify-center gap-8 w-full mr-10 px-4">
                        <div
                            className={`flex items-center justify-center gap-4 w-full transition-all duration-1000 delay-500 ${
                                isVisible
                                    ? "opacity-100 translate-y-0"
                        ...
                        <div
                            className={`flex flex-col items-center gap-4 transition-all duration-1000 delay-700 ${
                                isVisible
                                    ? "opacity-100 translate-y-0"
                                    : "opacity-0 translate-y-10"
                            }`}
