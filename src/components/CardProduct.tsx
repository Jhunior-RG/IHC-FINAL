...
const CardProduct = ({ product }: { product: Product }) => {
    return (
        <>
            <div className="border rounded-2xl p-4 shadow-md hover:shadow-lg transition duration-300 flex flex-col items-center bg-white w-[300px] justify-between relative">
                ...
                <Image
                    ...
                    height={150}
                />
                <h3 className="text-center text-sm mb-1">{product.name}</h3>
                {product.priceDiscount ? (
