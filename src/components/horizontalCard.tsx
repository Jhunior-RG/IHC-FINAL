    ...
    return (
        <>
            <Link href={`/product/${product.id}`}>
                <Card className="border rounded-2xl p-4 shadow-md hover:shadow-lg transition-all duration-300 bg-white relative group cursor-pointer hover:scale-102 mt-5">
