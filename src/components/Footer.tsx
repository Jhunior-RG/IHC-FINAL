                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                    <div className="flex flex-col space-y-4">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-3xl font-bold font-['Croissant_One'] text-white">
                                PawFuel
                            </h2>
                        </div>
                        <p className="text-primary-foreground/80 text-sm leading-relaxed max-w-sm">
                            ...
                            envío a domicilio a la puerta de tu casa.
                        </p>
                    </div>
                ...
                <div className="border-t border-white/20 mt-8 pt-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-primary-foreground/60 text-sm">
                            © {new Date().getFullYear()} PawFuel. Todos los
                            derechos reservados.
                        </p>
