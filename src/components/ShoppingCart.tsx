...
const ShoppingCart = () => {
  const { getCartCount, cart, addToCart, removeFromCart, clearCart } = useCart()
              ...
              {cart.map((item) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-primary font-semibold mt-1">Bs. {item.price}</p>
                  </div>
                  ...
                  <div className="flex flex-col items-end gap-2">
                    ...
                    <p className="text-sm font-semibold text-gray-900">Bs. {item.price * item.quantity}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <>
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-lg font-bold text-primary">Bs. {total}</span>
              </div>
